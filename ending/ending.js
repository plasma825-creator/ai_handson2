...
const lyrics = [
  ...
  { time: 7.2, text: '酪農の野に　牛は立ち' },
  { time: 10.2, text: '学びの鐘は　今日も鳴る' },
  { time: 13.2, text: '重き日々にも　灯をかかげ' },
  { time: 16.2, text: '知恵をたずねて　道を行く' },
  { time: 19.2, text: '過ぎしカコクを　越えながら' },
  { time: 22.2, text: '明日の丘へ　歩み出す' },
  { time: 26.0, text: 'ああ　金沢国際酪農大学' },
  { time: 30.0, text: '旭台キャンパス' },
  { time: 33.2, text: 'われらは進む　ラク大へ' },
  { time: 38.0, text: 'ラク大へ　いま一歩' },
  { time: 41.5, text: 'ラク大へ　いま一歩' },
  { time: 45.0, text: 'ラク大へ　いま一歩' },
  { time: 51.0, text: '' }
];
